...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3 animate-up">
    <div>
        <h1 class="h3 fw-bold mb-1 text-dark-gradient">Create Expense Category</h1>
        <p class="text-muted mb-0">Add a new expense category to categorize transactions.</p>
    </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
            <div class="card-header border-0 bg-light-soft py-3 px-4">
                <h5 class="card-title fw-bold text-dark mb-0">
                    <i class="fas fa-folder-plus text-primary me-2"></i>Category Information
                </h5>
            </div>
            <form action="{{ route('admin.expense-categories.store') }}" method="POST">
                ...
                <div class="card-body p-4">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control form-control-modern" id="name" name="name" placeholder="e.g., Marketing, Utilities, Office Supplies" required>
                    </div>
                    <div class="mb-2">
                        <label for="description" class="form-label fw-semibold text-muted">Description</label>
                        <textarea class="form-control form-control-modern" id="description" name="description" rows="5" placeholder="Describe the purpose or items included under this category..."></textarea>
                    </div>
                </div>
                <div class="card-footer border-0 bg-white p-4 pt-0 d-flex gap-2 justify-content-end">
                    ...
                    <button type="submit" class="btn btn-indigo px-4 shadow-indigo">Save Category</button>
                </div>
            </form>
        </div>
    </div>
